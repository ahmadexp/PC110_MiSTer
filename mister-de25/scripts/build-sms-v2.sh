...
export DE25_SMS_PROJECT=DE25_MISTER_SMS_V2
export DE25_SMS_OUTPUT_DIRECTORY=output_files_sms_v2
export DE25_SMS_OUTPUT_RBF="$platform_root/artifacts/sms-v2/SMS_v2.rbf"
...
exec "$platform_root/scripts/build-sms.sh"
