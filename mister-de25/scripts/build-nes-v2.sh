...
export DE25_NES_PROJECT=DE25_MISTER_NES_V2
export DE25_NES_OUTPUT_DIRECTORY=output_files_nes_v2
export DE25_NES_OUTPUT_RBF="$platform_root/artifacts/nes-v2/NES_v2.rbf"
...
exec "$platform_root/scripts/build-nes.sh"
