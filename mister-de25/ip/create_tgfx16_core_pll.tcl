...
# Agilex 5 replacement for TurboGrafx16's fixed Cyclone V PLL. C0 is the
# 85.9088 MHz RAM/video clock and C1 is the 42.9544 MHz system clock. Upstream
# uses a 180 degree C1 phase relationship, represented here as half its period.
create_system tgfx16_core_pll
...
set_instance_parameter_value iopll_0 gui_output_clock_frequency0 85.9088
set_instance_parameter_value iopll_0 gui_output_clock_frequency1 42.9544
set_instance_parameter_value iopll_0 gui_phase_shift1 11640.0
...
save_system tgfx16_core_pll.qsys
