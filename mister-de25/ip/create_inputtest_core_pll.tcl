...
# Agilex 5 replacement for InputTest's Cyclone V `pll`: 50 MHz in and a
# single 24 MHz system clock out. The HDL wrapper retains the upstream ports.
create_system inputtest_core_pll
...
set_instance_parameter_value iopll_0 gui_output_clock_frequency0 24.0
...
save_system inputtest_core_pll.qsys
