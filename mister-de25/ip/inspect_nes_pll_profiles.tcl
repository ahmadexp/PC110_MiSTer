...
# Ask the installed Agilex 5 IOPLL solver for the two complete NES timing
# profiles.  C0 clocks the SDRAM controller, C1 is CLK_VIDEO, C2 is the NES
# master clock, C3 is forwarded to the SDRAM, and C4 captures SDRAM reads.
# C3 launches the SDRAM clock just before the opposite C0 edge. C4 samples
# reads near the end of the controller cycle, after the SDRAM's 5.5 ns tAC
# interval has elapsed and before the next C0 edge.
set profiles {
    {ntsc 85.9090880 42.9545440 21.4772720}
    {pal  85.1254784 42.5627392 21.2813696}
}

create_system inspect_nes_pll_profiles
...
foreach profile $profiles {
    ...
    set capture_phase_ps  [expr {1000000.0 / double($controller) - 500.0}]
    ...
    send_message info "NES_PROFILE [string trim $output]"
