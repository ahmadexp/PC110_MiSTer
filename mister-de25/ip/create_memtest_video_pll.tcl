...
# MemTest's fixed 27 MHz video clock remains independent of the SDRAM clock.
create_system memtest_video_pll
...
set_instance_parameter_value iopll_0 gui_output_clock_frequency0 27.0
...
save_system memtest_video_pll.qsys
